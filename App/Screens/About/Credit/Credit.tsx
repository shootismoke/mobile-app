...
import {
	handleOpenAmaury, handleOpenMarcelo,
	handleOpenOpenAQ, handleOpenWaqi,
	handleOpenGithub
} from '../Bookmarks';
		...
		<View style={styles.credits}>
			...
			<Text style={theme.text}>
				<Trans
					...
					t={t}
				>
					Concept {'&'} Development by <Exlink dest={handleOpenAmaury}>{'{{author}}'}</Exlink>.
				</Trans>{'\n'}
				<Trans
					...
					t={t}
				>
					Design {'&'} Copywriting by <Exlink dest={handleOpenMarcelo}>{'{{author}}'}</Exlink>.
				</Trans>{'\n'}{'\n'}
				<Trans i18nKey='credits.database' t={t}>
					Air quality data from <Exlink dest={handleOpenWaqi}>WAQI</Exlink> and <Exlink dest={handleOpenOpenAQ}>OpenAQ</Exlink>.
				</Trans>{'\n'}
				<Trans i18nKey='credits.source_code' t={t}>
					Source code <Exlink dest={handleOpenGithub}>available on Github</Exlink>.
				</Trans>{'\n'}{'\n'}
				{`${appName} v${appVer}`}.
			</Text>
